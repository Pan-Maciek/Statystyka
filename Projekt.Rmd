...
=======
```{R}
plot(gdp('USA'), main="PKB per capita w USA", xlab="Rok", ylab="Dolarów")
plot(gdp('AUT'), main="PKB per capita w Austrii", xlab="Rok", ylab="Dolarów")
plot(gdp('CHN'), main="PKB per capita w Chinach", xlab="Rok", ylab="Dolarów")
plot(gdp('IND'), main="PKB per capita w Indiach", xlab="Rok", ylab="Dolarów")
plot(gdp('BRA'), main="PKB per capita w Brazylii", xlab="Rok", ylab="")
plot(gdp('NGA'), main="PKB per capita w Nigerii", xlab="Rok", ylab="Dolarów")
plot(gdp('AUS'), main="PKB per capita w Australii", xlab="Rok", ylab="Dolarów")
```
